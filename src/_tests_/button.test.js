...
describe('yellow button input value', () => {
  it('updates on change', () => {
    ...
    const searchInput = screen.getByTestId('yellowButtonInput');
...
describe('toggling button disabled', () => {
  it('toggles disabled to false', () => {
    render(<Button/>)
    const disabled = screen.getByTestId('green-button');
